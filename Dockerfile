...
RUN wget https://download.nextcloud.com/server/releases/nextcloud-20.0.12.tar.bz2 -O /tmp/nextcloud.tar.bz2 \
...
RUN wget https://github.com/nextcloud-releases/richdocuments/releases/download/v3.8.6/richdocuments.tar.gz -O /tmp/richdocuments.tar.gz \
...
RUN wget https://github.com/nextcloud/user_saml/releases/download/v3.3.5/user_saml-3.3.5.tar.gz -O /tmp/user_saml.tar.gz \
